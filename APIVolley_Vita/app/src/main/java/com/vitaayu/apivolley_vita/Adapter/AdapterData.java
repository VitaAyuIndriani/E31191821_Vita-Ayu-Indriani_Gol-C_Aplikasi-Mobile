package com.vitaayu.apivolley_vita.Adapter;
...
import com.vitaayu.apivolley_vita.Insert;
import com.vitaayu.apivolley_vita.Model.ModelData;
import com.vitaayu.apivolley_vita.R;
...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData>{
    ...
    class  HolderData extends RecyclerView.ViewHolder
    {
        ...
        public HolderData (View view){
            super(view);
            tvusername = (TextView) view.findViewById(R.id.inp_username);
            tvgrup = (TextView) view.findViewById(R.id.inp_grup);
            tvnama = (TextView) view.findViewById(R.id.inp_nama);
            tvpassword = (TextView) view.findViewById(R.id.inp_password);
